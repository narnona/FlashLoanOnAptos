module FlashLoan::flash_loan {
    ...
    // ======================== Read Functions ========================
    #[view]
    public fun get_UserStake(faCoin_addr: address): SimpleMap<address, u64> acquires UserStake {
    ...
    #[view]
    public fun get_FACoinItem_object_address(faCoin_addr: address): address acquires FACoinPoolController {
